...
(for_statement start_keyword: "for" @keyword)
(for_statement in_keyword: "in" @keyword)
(for_statement do_keyword: "do" @keyword)
(for_statement end_keyword: "end" @keyword)
...
;; Built-in functions - highlight as special
(
